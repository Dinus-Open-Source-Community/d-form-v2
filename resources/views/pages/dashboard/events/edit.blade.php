<x-layout::dashboard title="Edit events">
    <div class="container mx-auto">
        <x-core::breadcrumb.wrapper>
            ...
            <x-core::breadcrumb.link :href="route('dashboard.events.show', [$event['id']])">
                {{ ucfirst($event['title']) }}
            </x-core::breadcrumb.link>
            <x-core::breadcrumb.item>Edit</x-core::breadcrumb.item>
        </x-core::breadcrumb.wrapper>

        <h1 class="mb-3 block text-3xl font-bold lg:hidden">Create events</h1>

        @livewire('event.edit-form', [$event])
    </div>
</x-layout::dashboard>
