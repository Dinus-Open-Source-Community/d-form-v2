...
* @route '/livewire-7b6f72f8/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-7b6f72f8/livewire.js',
...
* @route '/livewire-7b6f72f8/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-7b6f72f8/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-7b6f72f8/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-7b6f72f8/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
