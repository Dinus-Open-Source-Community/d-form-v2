...
* @route '/livewire-7b6f72f8/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-7b6f72f8/upload-file',
...
* @route '/livewire-7b6f72f8/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-7b6f72f8/preview-file/{filename}',
